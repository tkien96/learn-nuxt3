<template>
    ...
    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
        <div class="w-full">
            ...
            <formTextInput :is-first-element="true" :input-label="'E-mail'" :place-holder="'made.with@love.me'" v-model="credentials.login"/>
            <formTextInput :input-label="'Password'" :place-holder="'*********'" :type="'password'" v-model="credentials.password"/>
